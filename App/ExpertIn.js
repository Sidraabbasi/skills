...
class InterestedIn extends Component<> {
    ...
    callAddAPI(obj){
        ...
        NetworkApiCall.initPostInstance(KeysNetwork.ADD_INTEREST_END_POINT, JSON.stringify(obj))
    ...
    componentDidMount() {
        ...
        if (this.props.loginResponse !== undefined && this.props.loginResponse !== null) {
            ...
            NetworkApiCall.initPostInstance(KeysNetwork.INTEREST_END_POINT, JSON.stringify(obj))
                .then((response) => response.json())
                .then((res) => {
                    console.log(res);
